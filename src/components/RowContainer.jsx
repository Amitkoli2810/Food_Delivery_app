    ...
    >
      {data && data.length > 0  ?
        data?.map((item) => (
          <div
            key={item?.id}
            className="w-275 h-[200px] min-w[275px] md:min-w-[300px]
                 md:w-300 md:h-[250px] hover:drop-shadow-lg my-12 py-2 px-4 bg-cardOverlay rounded-lg   backdrop-blur-lg
          ...
          >
            <div className="w-full flex items-center justify-between">
              ...
              <motion.div
                whileTap={{ scale: 0.75 }}
                className="w-8 h-8 rounded-full bg-red-800 flex
            ...
            <img src={NotFound} className='340px' alt="Not Found"/>
