        ...
        <div className='w-full flex items-center justify-between'>
          <p className='text-2xl font-semibold capitalize text-headingColor relative before:absolute
           ...
           <div className="md:flex hidden gap-3 items-center">
            <motion.div whileTap={{scale : 0.75}} className='w-8 h-8 rounded-lg bg-orange-300 flex
            hover:bg-orange-500 cursor-pointer transition-all duration-100
            ease-in-out shadow-lg items-center justify-center' onClick={()=> setScrollValue(-200)} >
