...
const CreateContainer = () => {
  ...
  return (
    <div className="w-full h-auto min-h-screen flex items-center justify-center">
      <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-8">
        {fields && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="flex items-center w-full ">
          <button
            type="button"
            className="ml-0 md: md-auto w-full md:w-auto border-none outline-none
