...
import Avatar2 from "../img/logged.jpg";
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <motion.img
              whileTap={{ scale: 0.6 }}
              src={user ? Avatar2 : Avatar}
              className="w-6 min-w-[40px] h-6 min-h-[40px] drop-shadow-xl cursor-pointer rounded-sm"
              alt="userprofile"
              onClick={login}
            />
            {isMenu && (
              ...
              >
                {user && user.email === "amitkoli108@gmail.com" && (
                  <Link to={"/createItem"}>
            ...
            >
              ...
              <ul className="flex flex-col ">
                <li className="text-base text-textColor hover:text-headingColor
                 hover:bg-slate-100 px-4 py-2 duration-100 transition-all ease-in-out cursor-pointer" onClick={()=> setIsMenu(false)}>
                  Home
                </li>
                <li className="text-base text-textColor hover:text-headingColor
                 hover:bg-slate-100 px-4 py-2 duration-100 transition-all ease-in-out cursor-pointer" onClick={()=> setIsMenu(false)}>
              ...
              <p
                onClick={logout}
                className="m-2 p-2 rounded-md shadow-md flex items-center gap-3 cursor-pointer justify-center
                 bg-gray-200 hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base"
              >
                Logout <MdLogout />
              </p>
            </motion.div>
